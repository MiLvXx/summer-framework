...
import com.xuxin.summer.web.controller.ControllerConfiguration;
import com.xuxin.summer.web.controller.ApiController.SigninObj;
...
public class DispatcherServletTest {
    ...
    MockServletContext createMockServletContext() {
        ...
        var ctx = new MockServletContext("file://" + path);
    ...
    MockHttpServletRequest createMockRequest(String method, String path, Object body, Map<String, String> params) {
        ...
        if (method.equals("GET") && params != null) {
            params.keySet().forEach(key -> req.setParameter(key, params.get(key)));
