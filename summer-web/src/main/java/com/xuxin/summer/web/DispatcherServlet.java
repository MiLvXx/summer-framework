...
import com.xuxin.summer.exception.ErrorResponseException;
import com.xuxin.summer.exception.NestedRuntimeException;
import com.xuxin.summer.exception.ServerErrorException;
import com.xuxin.summer.exception.ServerWebInputException;
...
import com.xuxin.summer.web.utils.PathUtils;
    ...
    static class Dispatcher {
        ...
        public Dispatcher(String httpMethod, boolean isRest, Object controller, Method method, String urlPattern) throws ServletException {
            ...
            for (int i = 0; i < params.length; i++) {
                this.methodParameters[i] = new Param(httpMethod, method, params[i], paramsAnnotations[i]);
            }
